 ...
 *
 * <p>The {@link org.jboss.quickstarts.wfk.contacts.security.authorization.UserLoggedIn} enforce that only previously authenticated users are allowed to invoke this service.</p>
 *
 * @author Pedro Igor
 */
@Path("/security/login")
